...
5. **branchName**: Derive from feature name (without date), kebab-case, prefixed with `ralph/`. For example, source file `prd-2026-03-15-task-status.md` → `branchName: "ralph/task-status"`
